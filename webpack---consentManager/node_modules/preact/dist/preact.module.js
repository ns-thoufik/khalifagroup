...
function b(n, l, u, t, i, r, o, c, s) {
    ...
    if (c == f && (c = null != r ? r[0] : _ ? w(u, 0) : null), h = 0, l.__k = x(l.__k, function(u) {
        ...
        for (h = r.length; h--;) null != r[h] && a(r[h]);
    for (h = _; h--;) null != k[h] && D(k[h], k[h]);
    if (g)
        for (h = 0; h < g.length; h++) A(g[h], g[++h], g[++h])
}

function x(n, l, u) {
    if (null == u && (u = []), null == n || "boolean" == typeof n) l && u.push(l(null));
    else if (Array.isArray(n))
        for (var t = 0; t < n.length; t++) x(n[t], l, u);
...
function N(n, l, u, t, i) {
    ...
    if ("key" === (l = i ? "className" === l ? "class" : l : "class" === l ? "className" : l) || "children" === l);
        ...
        if (r = n.style, "string" == typeof u) r.cssText = u;
            ...
            if (u)
                for (f in u) t && u[f] === t[f] || P(r, f, u[f])
        }
...
function D(l, u, t) {
    ...
    if (i = l.__k)
        for (o = 0; o < i.length; o++) i[o] && D(i[o], u, t);
    null != r && a(r)
}
...
export {
    I as render, L as hydrate, h as createElement, h, d as Fragment, p as createRef, l as isValidElement, m as Component, M as cloneElement, O as createContext, x as toChildArray, D as _unmount, n as options
};
