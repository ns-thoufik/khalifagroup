...
o.__e = function(n, t, r) {
    if (n.then && r)
        for (var e, o = t; o = o.__p;)
            if ((e = o.__c) && e.i) return r && (t.__e = r.__e, t.__k = r.__k), void e.i(n);
    h(n, t, r)
}, (m.prototype = new t).i = function(n) {
    var t = this;
    t.t.push(n);
    var r = function() {
        t.t[t.t.indexOf(n)] = t.t[t.t.length - 1], t.t.pop(), 0 == t.t.length && (e(t.props.fallback), t.__v.__e = null, t.__v.__k = t.state.u, t.setState({
            u: null
        }))
    };
...
function A(n) {
    ...
    return t.l && t.l !== r && (t.s.parentNode && t.l.removeChild(t.s), e(t.v), t.p = !1), n.vnode ? t.p ? (r.__k = t.__k, u(o, r), t.__k = r.__k) : (t.s = document.createTextNode(""), i("", r), r.insertBefore(t.s, r.firstChild), t.p = !0, t.l = r, u(o, r, t.s), t.__k = this.s.__k) : t.p && (t.s.parentNode && t.l.removeChild(t.s), e(t.v)), t.v = o, t.componentWillUnmount = function() {
        t.s.parentNode && t.l.removeChild(t.s), e(t.v)
    }, null
}
...
var F = function(n, t) {
    ...
    N = {
        ...
        only: function(n) {
            if (1 !== (n = l(n)).length) throw new Error("Children.only() expects only one child.");
            return n[0]
        },
        toArray: l
    };
...
function S() {
    ...
    var r = a.apply(void 0, n),
        e = r.type,
        o = r.props;
    return "function" != typeof e && (o.defaultValue && (o.value || 0 === o.value || (o.value = o.defaultValue), delete o.defaultValue), Array.isArray(o.value) && o.multiple && "select" === e && (l(o.children).forEach(function(n) {
        ...
        for (o in t)
            if (r = x.test(o)) break;
        if (r)
            for (o in e = n.props = {}, t) e[x.test(o) ? o.replace(/([A-Z0-9])/, "-$1").toLowerCase() : o] = t[o]
    }(r, o)), r.preactCompatNormalized = !1, R(r)
}

function R(n) {
    return n.preactCompatNormalized = !0,
        function(n) {
            var t = n.props;
            (t.class || t.className) && (z.enumerable = "className" in t, t.className && (t.class = t.className), Object.defineProperty(t, "className", z))
        }(n), n
}

function U(n) {
    return O(n) ? R(c.apply(null, arguments)) : n
}
...
function M(n, t) {
    ...
    for (var e in t)
        if ("__source" !== e && n[e] !== t[e]) return !0;
    return !1
}
...
function Z(n, t) {
    function r(n) {
        var r = this.props.ref,
            e = r == n.ref;
        return !e && r && (r.call ? r(null) : r.current = null), (t ? !t(this.props, n) : M(this.props, n)) || !e
    }
...
o.vnode = function(n) {
    ...
    var t = n.type;
    t && t.o && n.ref && (n.props.ref = n.ref, n.ref = null), "function" == typeof t && !t.h && t.prototype && (L(t.prototype, "componentWillMount"), L(t.prototype, "componentWillReceiveProps"), L(t.prototype, "componentWillUpdate"), t.h = !0), T && T(n)
};
var V = function(n, t) {
    return n(t)
};
...
export {
    b as version, N as Children, _ as render, _ as hydrate, j as unmountComponentAtNode, k as createPortal, S as createElement, E as createFactory, U as cloneElement, O as isValidElement, P as findDOMNode, W as PureComponent, Z as memo, D as forwardRef, V as unstable_batchedUpdates, m as Suspense, y as lazy
};
