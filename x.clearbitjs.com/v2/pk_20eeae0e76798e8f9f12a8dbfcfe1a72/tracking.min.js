...
(function(f) {
    ...
    return function() {
        ...
        1: [function(require, module, exports) {
            ...
            "../package.json": 120,
            "./integrations": 2,
            "@clearbit-dcp/clearbit.js-core": 7
        }],
        2: [function(require, module, exports) {
            ...
            "@clearbit-dcp/clearbit.js-integration-clearbit": 18
        }],
        ...
        5: [function(require, module, exports) {
            ...
            Entity.prototype.initialize = function() {
                if (!window.__clearbit_no_cookies) {
        ...
        13: [function(require, module, exports) {
            ...
            exports.parse = function(str) {
                ...
                for (var i = 0; i < pairs.length; i++) {
                    ...
                    obj[key] = null == parts[1] ? "" : decode(parts[1])
                }
                return obj
            };
        ...
        18: [function(require, module, exports) {
            ...
            var Clearbit = exports = module.exports = integration("Clearbit").option("apiKey", "").option("apiHost", "app.clearbit.com/v1").option("crossDomainIdServers", []).option("retryQueue", false).option("addBundledMetadata", false).option("unbundledIntegrations", []);
            ...
            "@ndhoule/extend": 32,
            "@ndhoule/keys": 35,
            "@segment/ad-params": 39,
            "@segment/analytics.js-integration": 19,
            "@segment/localstorage-retry": 48,
            "@segment/protocol": 58,
            "@segment/send-json": 59,
            "@segment/top-domain": 61,
            "@segment/utm-params": 62,
            "component-clone": 65,
            "component-cookie": 66,
            json3: 85,
            "spark-md5": 110,
        ...
        74: [function(require, module, exports) {
            ...
            exports.parse = function(str) {
                ...
                for (var i = 0; i < pairs.length; i++) {
                    ...
                    var m;
                    if (m = pattern.exec(key)) {
                        var objKey = sanitizeObjKey(m[1]);
                        obj[objKey] = obj[objKey] || [];
                        obj[objKey][m[2]] = decode(parts[1]);
                        continue
                    }
                    obj[key] = null == parts[1] ? "" : decode(parts[1])
                }
        ...
        120: [function(require, module, exports) {
            module.exports = {
                ...
                version: "0.0.2",
                description: "The hassle-free way to integrate analytics into any web application.",
                keywords: ["analytics", "clearbit.js", "clearbit", "clearbit.io"],
                main: "clearbit.js",
                scripts: {
                    build: "make build",
                    clean: "make clean",
                ...
                devDependencies: {
                    "@clearbit-dcp/clearbit.js-core": "^0.1.0",
...
clearbit.initialize({
    "Clearbit": {
        "apiKey": "pk_20eeae0e76798e8f9f12a8dbfcfe1a72"
    }
});
