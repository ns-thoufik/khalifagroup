var JetboostBootstrap = function() {
    ...
    function d(t) {
        ...
        return e && (o[Symbol.iterator] = function() {
            return o
        }), o
    }
    ...
    function y() {
        return this.bodyUsed = !1, this._initBody = function(e) {
            ...
            var t, e, o, r = u(this);
            if (r) return r;
            if (this._bodyBlob) return t = this._bodyBlob, e = new FileReader, o = h(e), e.readAsText(t), o;
            if (this._bodyArrayBuffer) return Promise.resolve(function(t) {
                for (var e = new Uint8Array(t), o = new Array(e.length), r = 0; r < e.length; r++) o[r] = String.fromCharCode(e[r]);
                return o.join("")
    ...
    function m(t, e) {
        ...
        if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new l(e.headers)), this.method = (o = e.method || this.method || "GET", r = o.toUpperCase(), b.indexOf(r) > -1 ? r : o), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && n) throw new TypeError("Body not allowed for GET or HEAD requests");
        this._initBody(n)
    }
    ...
    T.polyfill = !0, self.fetch || (self.fetch = T, self.Headers = l, self.Request = m, self.Response = g);
    ...
    var O = function(t) {
        ...
        e.src = t, e.async = 1, document.getElementsByTagName("head")[0].appendChild(e)
    };
    const U = function(t) {
    ...
    return function(t) {
        var e;
        window.Jetboost = window.Jetboost || {}, window.Jetboost.loaded ? console.log("Ignoring extra Jetboost script") : (window.Jetboost.loaded = !0, e = function() {
            if (!document.querySelector("[class*='jetboost']")) return !1;
            ! function() {
                var t = "jetboost-list-search-styles";
                if (!document.getElementById(t)) {
                    var e = document.createElement("style");
                    e.id = t, e.type = "text/css", e.innerHTML = "." + S + " { display: none !important; } ." + j + " { visibility: hidden !important; }  @keyframes jetboost-fadeout-animation { 0% { opacity: 1; } 100% { opacity: 0.5; } } @keyframes jetboost-fadein-animation { 0% { opacity: 0.5; } 100% { opacity: 1; } }", document.getElementsByTagName("head")[0].appendChild(e)
                }
            }(),
            function() {
                for (var t = document.querySelectorAll(B(_)), e = 0; e < t.length; e++) t[e].className.includes(A) || t[e].classList.remove(_);
                document.querySelectorAll(B(x.SORT_ACTIVE)).forEach((function(t) {
                    t.className.includes(x.SORT_RESET) || t.classList.remove(x.SORT_ACTIVE)
                }))
            }();
            ...
            (function(t, e, o) {
                ...
                o && (r += "?staging=1");
                let n = null;
                const i = window.sessionStorage.getItem("jetboost-site-config-origin");
                return o || i === window.location.origin + window.location.pathname || (n = window.sessionStorage.getItem("jetboost-site-config")), n ? new Promise((t => {
                    t({
                        status: 200,
                        json: () => new Promise((t => {
                            t(JSON.parse(n))
            ...
            })(t, e, o).then((function(t) {
                200 === t.status ? t.json().then((function(t) {
                    window.sessionStorage.setItem("jetboost-site-config", JSON.stringify(t)), window.sessionStorage.setItem("jetboost-site-config-origin", window.location.origin + window.location.pathname);
                    var e = t.boosters;
                    window.Jetboost.boosters = e, t.majorVersion && (window.Jetboost.version = t.branchVersion || "v" + t.majorVersion + "." + t.minorVersion + "." + t.patchVersion);
                    var o = function(t) {
                        return !(!(1 === t.majorVersion && t.minorVersion >= 6) || t.branchVersion || !window.JetboostListSearchComplete && !window.JetboostPaginationComplete)
                    }(t);
                    if (o ? (console.error("The " + (window.JetboostListSearchComplete ? "JetboostListSearchComplete" : "JetboostPaginationComplete") + " function isn't supported by newer versions of Jetboost. Please contact our support team if you'd like to upgrade to the latest version! support@jetboost.io"), O(t.backwardsCompatScriptUrl)) : O(t.mainScriptUrl), t.plugins && t.plugins.length > 0) {
                        const e = !!document.querySelector("[class*='jetboost-map-']");
                        t.plugins.forEach((function(t) {
                            switch (t.name) {
                                case "mapbox":
                                    !window.mapboxgl && e && (U(t.cssUrl), O(t.scriptUrl));
                                    break;
                                case "geocoder":
                                    if (!window.MapboxGeocoder && e) {
                                        U(t.cssUrl), O(t.scriptUrl);
                                        var o = document.createElement("style");
                                        o.id = "jetboost-mapbox-overrides", o.innerHTML = ".mapboxgl-ctrl-geocoder { width: 100%; max-width: 100%; box-shadow: none; color: inherit; background: inherit; border-radius: inherit; font: inherit; } .mapboxgl-ctrl-geocoder--input { background: inherit; color: inherit; border-radius: inherit;} .mapboxgl-ctrl-geocoder--input::placeholder { color: inherit; } .mapboxgl-ctrl-geocoder--input:focus { background: inherit; color: inherit; border-radius: inherit; outline: inherit} .mapboxgl-ctrl-geocoder--button { background: inherit; } .mapboxgl-ctrl-geocoder--icon { fill: currentColor; } ", document.head.appendChild(o)
                                    }
                                    break;
                                case "markjs":
