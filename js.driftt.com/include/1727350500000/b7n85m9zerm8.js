! function(e) {
    ...
    (function(t) {
        "undefined" != typeof self && self, e.exports = function(e) {
            ...
            function function_serializeFunction(e, t, n, r, o) {
                ...
                a = (i = {
                    ...
                    return a("postrobot_method", {
                        ...
                        return l.try(function() {
                            ...
                            if (I.isProxyWindow(c)) return c.matchWindow(t, {
                                send: s
                            }).then(function(e) {
                ...
                return "string" == typeof u && "function" == typeof u.indexOf && 0 === u.indexOf("anonymous::") && (u = u.replace("anonymous::", r + "::")), I.isProxyWindow(e) ? (addMethod(c, n, u, e, t), e.awaitWindow().then(function(e) {
                    addMethod(c, n, u, e, t)
            ...
            function serializeMessage(e, t, n, r) {
                ...
                return function(e, t) {
                    ...
                    return isWindow(e) || I.isProxyWindow(e) ? serializeType("cross_domain_window", I.serialize(e, {
                        send: a
                    })) : e
                }, o))
            }
            ...
            function send_sendMessage(e, t, n, r) {
                ...
                return l.try(function() {
                    ...
                    return r.buffer = r.buffer || [], r.buffer.push(n), r.flush = r.flush || l.flush().then(function() {
                        ...
                        delete r.buffer;
                        for (var s = Object.keys(k), c = [], u = 0; u < s.length; u++) {
                            var f = s[u];
                            try {
                                k[f](e, a, t)
                            } catch (l) {
    ...
    var E = "function" === typeof Object.is ? Object.is : function _objectIs(e, t) {
        ...
        I = "function" !== typeof Object.keys || A ? _curry1(function keys(e) {
            if (Object(e) !== e) return [];
            var t, n, r = [],
                o = A && y(e);
            for (t in e) !_has(t, e) || o && "length" === t || (r[r.length] = t);
            if (x)
                for (n = S.length - 1; n >= 0;) _has(t = S[n], e) && !O(r, t) && (r[r.length] = t), n -= 1;
            return r
    ...
    var be = 76,
        ...
        Ie = Se,
        ke = "auto",
        Te = function getWidgetAlignment(e) {
            return e.$div.classList.contains("".concat("drift-frame", "-").concat(e.name, "-align-right")) ? U : z
        },
        Ce = void 0,
        Pe = function isMobileDevice() {
            var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            return void 0 === Ce && (Ce = Re(e) || Le(e)), Ce
        },
        Re = function isAndroid() {
        ...
        Le = function isIOS() {
            ...
            return /iPhone|iPod/i.test(null === (e = navigator) || void 0 === e ? void 0 : e.userAgent) || t && De()
        },
        Fe = function isInternetExplorerBrowser() {
        ...
        Ne = 512,
        je = 640,
        Ue = function getTargetedBreakpointByBrowser() {
            return We || (We = function isFirefox() {
                return navigator.userAgent.toLowerCase().indexOf("firefox") > -1
            }() ? Ne : function isSafari() {
                return /^((?!chrome|android).)*safari/i.test(navigator.userAgent)
            }() ? je : Me), We
        },
        ze = function isXSScreenSize() {
            var e = Ue();
        ...
        Ge = function isNewBreakPoint() {
            var e = !1,
                t = ze();
            return t !== Be && (e = !0), Be = t, e
        },
        qe = function getFrameStyles(e) {
            ...
            if (r ? a["max-height"] = n : a.height = n, "controller" === e && (a.bottom = i ? Ae : "24px"), "slider" === e) {
                var s = ze() ? "-20" : "20";
                a.bottom = i ? "0" : "18px", a.height = "calc(100% + ".concat(s, "px)"), i && (a.maxWidth = "335px")
            }
            return "emailCapture" === e && (a.bottom = Ae, a.height = "calc(100% + 30px)"), "takeover" !== e && "chat__takeover" !== e || (a.left = Ae, a.top = Ae, a.bottom = ke, a.right = ke, a.width = Se, a.height = Se, a["max-height"] = Se), "chat" === e && (a.bottom = "88px", a.opacity = Ae, a.visibility = "hidden", a["min-width"] = "320px", a.height = Se, a.width = Se, o === U ? a.right = "12px" : o === z && (a.left = "12px")), a
        },
        He = function setDivStyle(e, t, n, r, o, i) {
            ! function applyStylesToDiv(e, t) {
                Object.keys(t).forEach(function(n) {
                    "height" !== n && "width" !== n || Fe() ? e.style[n] = t[n] : e.style.setProperty(n, t[n], "important")
                })
            }(e, qe(o, t, n, r, i))
        },
        $e = function setDivAlignment(e, t, n) {
            var r = Pe(),
                o = r ? "0" : "24px",
                i = r ? "0" : "24px";
    ...
    const Ye = { ...{
        ...
        et = [Ye.READY, Ye.API_READY, Qe.CONTROLLER_READY, Qe.LANDINGPAGE_READY, Qe.CHAT_READY, Qe.CLEAR_EVENT_Q, Qe.ALL_FRAMES_READY];
    ...
    var nt, rt = function createEvent(e, t) {
            if (!window.drift.ready && !tt(e, et) && e !== Ye.BOOTSTRAP_FAILED) window.drift.iq.push({
                name: e,
                payload: t
            });
            else {
        ...
        ot = function isInIframeMode() {
            return !!window.drift_iframe_mode
        },
        it = function getIframeWindowContext() {
            return de(window.drift_iframe_window_context) ? window : window.drift_iframe_window_context
        },
        at = new function IframeModeResizeManager() {
            var e = this;
            _classCallCheck(this, IframeModeResizeManager), this._lastOffsetApplied = void 0, this._sendResizeEventForTakeover = function(t) {
                var n = Y[N.TAKEOVER],
                    r = Y[N.CONTROLLER];
                $e(r.$div, N.CONTROLLER, t), r.$div.style.bottom = e._lastOffsetApplied.vertical ? e._lastOffsetApplied.vertical : "12px", r.$div.style[t] = e._lastOffsetApplied.horizontal ? e._lastOffsetApplied.horizontal : "12px";
                var o = e._getIframeWrappedStyles(n, t);
                rt(Ye.IFRAME_RESIZED, {
                    styles: o
                })
            }, this.checkAndApplyOffsets = function(t, n) {
                var r, o, i;
                if (ot() && ze() && (null === Y || void 0 === Y ? void 0 : null === (r = Y.chat) || void 0 === r ? void 0 : null === (o = r.$div) || void 0 === o ? void 0 : null === (i = o.classList) || void 0 === i ? void 0 : i.contains("drift-chat-open"))) return t.bottom = 0, void(t[n] = 0);
                ...
                e.checkAndApplyOffsets(r, t), rt(Ye.IFRAME_RESIZED, {
                    styles: r
                })
                ...
                r.$div.style.bottom = Ae, n.$div.style.bottom = Ae, e.checkAndApplyOffsets(o, t), rt(Ye.IFRAME_RESIZED, {
                    styles: o
                })
                ...
                if (n && r) {
                    ...
                    e.checkAndApplyOffsets(o, t), rt(Ye.IFRAME_RESIZED, {
                        styles: o
                    })
                }
                ...
                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : U,
                    ...
                    o = {
                        ...
                        "max-height": function getHeightStyle() {
                            ...
                            return 0 === i ? "0px" : 0 === o ? "".concat(i, "px") : r ? Se : "".concat(n + i, "px")
                        }()
                    };
                return r && (o.left = n === U ? ke : Ae, o.right = n === U ? Ae : ke, o.bottom = Ae), e.style.bottom = "64px", n === U ? (e.style.right = "-12px", t.style.right = Ae) : (e.style.left = "-12px", t.style.left = Ae), t.style.bottom = Ae, o
            }, this._getIframeWrappedStyles = function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : U;
                if (e.name === N.TAKEOVER) return _objectSpread2(_objectSpread2({}, qe(N.TAKEOVER)), {}, {
                    border: "none"
                });
                if (e.name === N.EMAIL_CAPTURE) {
                    var n = _objectSpread2(_objectSpread2({}, qe(N.EMAIL_CAPTURE)), {}, {
                ...
                if (e.name === N.SLIDER) {
                    ...
                    return _objectSpread2(_objectSpread2({}, qe(N.SLIDER)), {}, {
                        width: "".concat(r, "px"),
                        top: ke,
                        bottom: "24px",
                        left: t === U ? ke : "24px",
        ...
        ut = _curry2(_dispatchable(["find"], _curry2(function _xfind(e, t) {
            return new ct(e, t)
        }), function find(e, t) {
        ...
        ft = n(3),
        lt = function getNonMobileResponsiveChatHeight(e, t) {
            var n, r;
    ...
    var dt = [N.EMAIL_CAPTURE, N.SLIDER, N.TAKEOVER],
        pt = function onFrameDimensionsChanged() {
            at.handleFrameResize()
        },
        ht = function killFrame(e) {
            var t = e.name;
            Y[t] || ae({
                type: "log",
            ...
            n && n.parentNode && n.parentNode.removeChild(n), delete Y[t], pt()
        },
        mt = function killAnnouncementFrames() {
        ...
        wt = function hideFrameFromScreenReaders(e) {
            var t = e.name,
                n = Y[t];
            if (n) {
                var r = n.$div,
        ...
        vt = function showFrameToScreenReaders(e) {
            var t = e.name,
                n = Y[t];
            if (n) {
                var r = n.$div,
        ...
        yt = function generateFrame(e) {
            ...
            if (!Y[t]) {
                ...
                v.setAttribute("class", "".concat("drift-frame", "-").concat(t)), v.setAttribute("scrolling", "no"), v.setAttribute("title", H[t]), v.setAttribute("allow", "autoplay; encrypted-media; fullscreen;"), v.setAttribute("frameborder", "0"), null != window.drift_iframe_sandbox && window.drift_iframe_sandbox.length > 0 && v.setAttribute("sandbox", window.drift_iframe_sandbox),
                    function setFrameStyle(e) {
                        var t = Pe();
                        e.style.background = "transparent", e.style.width = t ? "1px" : Se, e.style.maxWidth = Se, e.style.height = t ? "1px" : Se, e.style.border = "none", t && (e.style.minWidth = Se, e.style.minHeight = Se)
                    }(v);
                var y = he(),
                    _ = "";
                t !== N.EMAIL_CAPTURE && t !== N.SLIDER && t !== N.TAKEOVER || (_ = "?isXSScreenSize=" + ze()), v.src = "".concat(y, "/").concat(s).concat(_);
                var b = Vt({
                    name: t,
                    frame: v,
                    height: r,
        ...
        _t = function setOffsetForFrames(e) {
            var t = e.offset,
                n = e.type,
                r = e.affectedStyle,
                o = e.maxOffset,
            ...
            "string" === typeof t && (t = t.replace("px", ""), t = parseFloat(t), isNaN(t)) ? se(["Unable to apply ".concat(n, " offset - invalid input ").concat(t)]) : ot() ? at.applyOffset(t, n, r) : st(Y).forEach(function(e) {
                var c = e.$div,
                    d = e.name,
                    p = t,
                    h = ut(function(e) {
        ...
        bt = function setHorizontalOffsetForFrames(e) {
            var t = e.offset,
                n = Te(Y.controller);
            _t({
                offset: t,
                type: "horizontal",
                maxOffset: 330,
                maxPreviewSizeDefault: Ee,
                nonMobileResponsiveSize: lt(Y.chat, Ee),
        ...
        Et = function setVerticalOffsetForFrames(e) {
            var t = e.offset,
            ...
            _t({
                ...
                nonMobileResponsiveSize: lt(Y.chat, n),
        ...
        xt = function alignFrames(e) {
            var t = e.alignment,
                n = void 0 === t ? U : t,
                r = Pe() ? ["controller", "slider"] : ["controller", "slider", "chat"];
            st(Y).forEach(function(e) {
                var t = e.$div,
        ...
        At = le(function(e) {
            return function setFrameDimensions(e) {
                ...
                var o = Y[r],
                    ...
                    s = i.style.height,
                    c = i.style.width;
                s === t && c === n || (i.style.height = t, a.style.height = t, i.style.width = n, a.style.width = n, pt())
            }({
                height: e.height,
                width: e.width,
                name: e.name
        ...
        Ot = function toggleClassByCondition(e, t, n) {
            t ? e.classList.add(n) : e.classList.contains(n) && e.classList.remove(n)
        },
        It = function setFrameHeight(e) {
            ...
            if (g !== i && !w) {
                var v = c && f && g !== Ae && i !== Ae;
                Ot(m, c, "with-transition"), Ot(m, v, "with-height-transition");
                var y = null === (t = Ft()) || void 0 === t ? void 0 : t.innerHeight,
                    _ = "".concat(null !== (n = null === (r = Ft()) || void 0 === r ? void 0 : null === (o = r.visualViewport) || void 0 === o ? void 0 : o.height) && void 0 !== n ? n : y, "px"),
                    b = i === _ || i === y || "100%" === i;
                a === N.CONTROLLER && (i = function getAndPersistHeight(e, t, n) {
                    return e.dataset.prevHeight && (t = e.dataset.prevHeight, delete e.dataset.prevHeight), t === Ae && (e.dataset.prevHeight = n), t
                }(m, i, g)), d ? (a === N.CHAT && (Ct(kt), m.style.setProperty("height", Pe() || ze() ? Le() ? Oe : _ : "calc(100% - 75px)", "important")), m.style.setProperty("max-height", i, "important"), b && Pe(!1) && !Le() && Tt(kt)) : m.style.setProperty("height", i, "important"), pt()
            }
        },
        kt = function mobileDetection() {
            var e, t, n, r, o = null === (e = Ft()) || void 0 === e ? void 0 : e.innerHeight,
                i = null !== (t = null === (n = Ft()) || void 0 === n ? void 0 : null === (r = n.visualViewport) || void 0 === r ? void 0 : r.height) && void 0 !== t ? t : o;
            o !== i && It({
                height: "".concat(i, "px"),
                name: N.CHAT,
                transition: !0
        ...
        Pt = function setFrameWidth(e) {
            ...
            var i = Y[n],
                a = i.$div,
                s = i.$frame;
            if (a.style.width !== t) return Ot(a, o, "with-transition"), a.style.setProperty("width", t, "important"), s.style.setProperty("width", t, "important"), a.style.width
        },
        Rt = function() {
            var e = _asyncToGenerator(i.a.mark(function _callee(e) {
        ...
        Lt = function setResponsiveChatHeight(e) {
            var t = e || {},
                n = t.name,
                r = void 0 === n ? "chat" : n,
                o = t.defaultHeight,
            ...
            if (! function isIframeModeAndChatClosed(e) {
                ...
                var c = Pe() ? Oe : "".concat(lt(Y.chat, i), "px");
                It({
                    height: c,
                    name: r,
                    transition: s
        ...
        Ft = function getWindow() {
            var e;
            return ot() && (null === (e = it()) || void 0 === e ? void 0 : e.window) || window
        },
        Bt = function setResponsiveChatWidth(e) {
            var t, n = e || {},
                ...
                c = void 0 === s || s,
                u = Ft().innerWidth;
            t = Pe() ? Ie : ze() ? "".concat(u, "px") : "".concat(u <= 380 ? u : a, "px"), Pt({
                width: t,
                name: o,
                transition: c
            }), pt()
        },
        Wt = function waitUntilInnerHeightSettles() {
        ...
        Mt = function toggleResponsiveClassName() {
            ...
            Pe() || (e ? toggleClassName(e) : st(Y).forEach(function(e) {
                return toggleClassName(e.$div)
            }))
        },
        Nt = null,
        jt = function setResponsiveChatDimensions() {
            Bt(), Lt()
        },
        Ut = function startResponsiveSizeListeners(e) {
            function broadcastReflowEvent() {
                Pe() || st(Y).forEach(function(t) {
                    var n, r = t.$div.id.replace("drift-frame-", "");
                    r && r !== N.CONTROLLER && (r !== N.CHAT || e) && ee({
                        name: r,
                        message: {
                            isXSScreenSize: ze(),
                            clientInnerHeight: null === (n = Ft()) || void 0 === n ? void 0 : n.innerHeight
                        },
            ...
            zt(), Nt = Object(ft.throttle)(200, !1, function createSizeChangeEventHandler(e) {
            ...
            }(broadcastReflowEvent)), Le(!0) ? window.addEventListener("orientationchange", Nt) : window.addEventListener("resize", Nt), Mt(), broadcastReflowEvent()
        },
        zt = function stopResponsiveSizeListeners() {
            Nt && (window.removeEventListener("orientationchange", Nt), window.removeEventListener("resize", Nt), Nt = null)
        },
        Gt = function toggleHasChat() {
            st(Y).forEach(function(e) {
                return e.$div.classList.add("drift-has-chat")
            })
        },
        qt = function toggleChatOpen(e, t) {
            t && (Pe() || ze()) && document.getElementsByTagName("html")[0].classList[e ? "add" : "remove"]("drift-widget-parent--chat-open");
            st(Y).forEach(function(t) {
                var n, r = t.$div,
                ...
                ! function toggleStylesOnChatOpen(e, t) {
                    var n, r = Pe(),
                        ...
                        i = o === N.CHAT,
                        a = o === N.CONTROLLER;
                    t ? i ? (e.style.opacity = "1", e.style.visibility = "visible", r && (e.style.bottom = Ae, e.style.right = Ae, e.style.left = Ae)) : r && a && (e.style.display = "none") : i ? (e.style.opacity = "0", e.style.visibility = "hidden") : r && a && (e.style.display = "block")
        ...
        Vt = function generateParentDivElement(e) {
            var t, n = e.name,
                r = e.frame,
                o = e.insertInside,
                i = void 0 === o ? "" : o,
                ...
                u = e.alignment,
                f = e.insertBefore;
            return !C(i) && Zt(i) ? ((t = document.getElementById(i)).appendChild(r), t) : ((t = function getOrCreateFrameContainer(e, t) {
                ...
                return r.length ? function removeAllChildrenFromElement(e) {
                    for (; e.firstChild;) e.removeChild(e.firstChild)
                }(n = r[0]) : ((n = document.createElement("div")).setAttribute("id", "".concat("drift-frame", "-").concat(e)), n.setAttribute("class", "drift-conductor-item ".concat("drift-frame", "-").concat(e, " ").concat("drift-frame", "-").concat(e, "-align-").concat(t)), $e(n, e, t)), Pe() && n.classList.add("".concat("drift-frame", "--mobile")), n
            }(n, u)).appendChild(r), He(t, s, a, c, n, u), Xt(t, f), t)
        },
        Xt = function addDivToParentPage(e, t) {
            t && Y[t] ? document.body.insertBefore(e, Y[t].$div) : document.body && document.body.appendChild(e)
        },
        Zt = function domElementExistsById(e) {
            return !!document.getElementById(e)
        };
    const Jt = ["SESSION_ID", "SESSION_STARTED", "ALWAYS_SEND_IDS", "SESSION_CAMPAIGNS", "NOTIFICATION_PLAYED"];

    function _identity(e) {
        return e
    }
    var Kt = _curry1(_identity);
    ...
    var Qt = function() {
        ...
        en = _curry2(function uniqBy(e, t) {
            for (var n, r, o = new Qt, i = [], a = 0; a < t.length;) n = e(r = t[a]), o.add(n) && i.push(r), a += 1;
            return i
        })(Kt);
    ...
    var tn = _curry2(function curryN(e, t) {
        ...
        nn = _curry1(function flip(e) {
            return tn(e.length, function(t, n) {
                var r = Array.prototype.slice.call(arguments, 0);
                return r[0] = n, r[1] = t, e.apply(this, r)
            })
        });
    var rn = _curry1(function isArrayLike(e) {
    ...
    var an = _curry2(function bind(e, t) {
    ...
    function _methodReduce(e, t, n, r) {
        return e["@@transducer/result"](n[r](an(e["@@transducer/step"], e), t))
    }
    var sn = "undefined" !== typeof Symbol ? Symbol.iterator : "@@iterator";

    function _reduce(e, t, n) {
        if ("function" === typeof e && (e = function _xwrap(e) {
                return new on(e)
            }(e)), rn(n)) return function _arrayReduce(e, t, n) {
            for (var r = 0, o = n.length; r < o;) {
        ...
        if (null != n[sn]) return _iterableReduce(e, t, n[sn]());
    ...
    var cn = function() {
        ...
        un = _curry2(_dispatchable(["filter"], _curry2(function _xfilter(e, t) {
            return new cn(e, t)
        }), function(e, t) {
            return _isObject(t) ? _reduce(function(n, r) {
                return e(t[r]) && (n[r] = t[r]), n
            }, {}, I(t)) : function _filter(e, t) {
                for (var n = 0, r = t.length, o = []; n < r;) e(t[n]) && (o[o.length] = t[n]), n += 1;
                return o
            }(e, t)
        })),
        fn = _curry2(function reject(e, t) {
            return un(function _complement(e) {
                return function() {
                    return !e.apply(this, arguments)
                }
            }(e), t)
        }),
        ln = _curry2(function(e, t) {
            return fn(nn(_includes)(e), t)
        }),
        dn = _curry2(_includes);
    const pn = ["visitCounts", "isChatFrameOpen", "useEnterToSubmit"];
    var hn = function clearDriftSessionStorage() {
            Jt.forEach(function(e) {
                return vn.removeItem(e)
            })
        },
        mn = function clearDriftLocalStorage() {
            pn.forEach(function(e) {
                return wn.removeItem(e)
            })
        },
        gn = function storageFactory(e) {
            var t = {},
            ...
            return {
                ...
                sadd: function sadd(e, t) {
                    var n = o(e) || [];
                    i(e, en([].concat(_toConsumableArray(n), [t])))
                },
                srem: function srem(e, t) {
                    var n = o(r(e)) || [];
                    i(e, JSON.stringify(ln([t], n)))
                },
    ...
    window.addEventListener("click", function() {
        ! function tryPlayAudioTrack() {
            window.drift_audio_context && (window.drift_audio_context.resume(), window.drift_notification_waiting && setTimeout(function() {
                xn(window.drift_notification_waiting), window.drift_notification_waiting = null
            }, 500))
        }()
    }, {
        once: !0
    });
    var xn = function playAudioTrack(e) {
        ...
        Sn = function isFirstInLineCheck(e) {
            return new Promise(function(t) {
                return window.thisTabID || (window.thisTabID = ie()), "hidden" !== document.visibilityState && e || yn("openTabs", window.thisTabID), setTimeout(_asyncToGenerator(i.a.mark(function _callee() {
                    var e, n;
                    return i.a.wrap(function _callee$(r) {
                        for (;;) switch (r.prev = r.next) {
                            case 0:
                                return r.next = 2, _n("openTabs");
                            case 2:
        ...
        An = function shallPlaySoundNotification(e, t) {
            return !(!0 === t && !w(e) && !0 === e)
        },
        On = function() {
            var e = _asyncToGenerator(i.a.mark(function _callee3(e) {
                ...
                return i.a.wrap(function _callee3$(s) {
                    for (;;) switch (s.prev = s.next) {
                        case 0:
                            t = e.chatOpen, r = e.notificationOnFirstVisitOnly, o = e.activeConversationId, a = !isNaN(o), Sn(t).then(function() {
                                var e = _asyncToGenerator(i.a.mark(function _callee2(e) {
                                    var t;
                                    return i.a.wrap(function _callee2$(o) {
                                        for (;;) switch (o.prev = o.next) {
                                            case 0:
                                                if (t = vn.get("NOTIFICATION_PLAYED"), e && (An(t, r) || a)) {
                                                    o.next = 3;
                                                    break
                                                }
                                            ...
                                            case 3:
                                                ...
                                                return o.next = 7, n.e(3).then(n.t.bind(null, 382, 7)).then(function(e) {
                                                    En = new Audio(e.default), xn(En), vn.set("NOTIFICATION_PLAYED", !0)
                                                }).catch(function(e) {
                                            ...
                                            case 7:
                                                ...
                                                break;
                                            case 9:
                                                xn(En), vn.set("NOTIFICATION_PLAYED", !0);
                                            case 11:
                                                o.next = 16;
                                                break;
                                            case 13:
    ...
    var Tn = function() {
                ...
                return i.a.wrap(function _callee$(i) {
                    for (;;) switch (i.prev = i.next) {
                        case 0:
                            ...
                            return s = encodeURIComponent(null === (n = document) || void 0 === n ? void 0 : null === (r = n.location) || void 0 === r ? void 0 : r.href), c = encodeURIComponent(null === (o = document) || void 0 === o ? void 0 : o.title), u = encodeURIComponent(null === (a = document) || void 0 === a ? void 0 : a.referrer), f = "https://api.company-target.com/api/v3/ip.json?auth=".concat(e, "&page=").concat(s, "&page_title=").concat(c, "&referrer=").concat(u), i.prev = 7, l = new AbortController, d = l.signal, p = !1, setTimeout(function() {
                                p || l.abort()
        ...
        Pn = function clearAllDriftCookies(e) {
            kn.map(function(t) {
                return _e.a.remove(t, {
                    domain: e
                })
            }), kn.map(function(e) {
                return _e.a.remove(e)
            })
        },
        Rn = function() {
            var e = _asyncToGenerator(i.a.mark(function _callee() {
                ...
                return i.a.wrap(function _callee$(i) {
                    for (;;) switch (i.prev = i.next) {
                        case 0:
                            return e = u.length > 0 && void 0 !== u[0] ? u[0] : {}, t = {}, In.forEach(function(e) {
                                var n = _e.a.get(e);
                                n && (t[e] = n)
                            }), i.next = 5, Tn(e.demandbaseToken);
                        case 5:
                            return (n = i.sent) && (t.demandbase = n), e.pardotId && (r = "".concat("visitor_id").concat(e.pardotId), (o = _e.a.get(r)) && (t.visitor_id = o)), a = _e.a.get(), s = {}, c = I(a) || [], Cn(function(e) {
        ...
        Dn = function setDriftCookie(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                ...
                o = n;
            return ot() && r && (o.sameSite = "none"), o.secure = r, _e.a.set(e, t, o)
        },
        Ln = _e.a.getJSON,
        Fn = _e.a.remove,
    ...
    var br = function hasUniversalAnalyticsGA() {
        ...
        Sr = function getNamespacedHitType(e, t) {
        ...
        Or = function GAPassThrough(e, t, n) {
            var r = n ? n.trim().toUpperCase() : "",
                ...
                i = xr(r),
                a = Er();
            (o || a || i) && ("UA" === r.substring(0, 2) && br() ? Ar(r, e, t) : i ? function sendGA4Event(e, t, n) {
                var r = {
            ...
            }(r, e, t) : br() ? Ar(r, e, t) : a && function sendLegacyEvent(e, t) {
                ...
                return i.a.wrap(function _callee2$(c) {
                    for (;;) switch (c.prev = c.next) {
                        ...
                        case 8:
                            ...
                            return c.next = 11, _e.a.get(e);
                        case 11:
                            if (a = c.sent, s = Date.now() - n, !a) {
                                c.next = 16;
                                break
                            }
                            return _e.a.remove(e), c.abrupt("return", a);
                        case 16:
                            s > r && (o = !0), c.next = 8;
                            break;
                        case 19:
        ...
        Br = {
                ...
                var e = _asyncToGenerator(i.a.mark(function _callee(e) {
                    ...
                    return i.a.wrap(function _callee$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", $t(t));
                            case 2:
                            case "end":
                                return n.stop()
                        }
            ...
            "generate-new-frame": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee2(e) {
                    ...
                    return i.a.wrap(function _callee2$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", yt({
                                    name: t.name,
                                    height: t.height,
                                    width: t.width,
                                    path: t.path,
            ...
            "show-frame-to-screen-reader": function showFrameToScreenReader(e) {
                var t = e.data,
                    ...
                    r = void 0 !== n && n;
                vt(t), r && function removeMobileFocusLoop() {
            ...
            "hide-frame-from-screen-reader": function hideFrameFromScreenReader(e) {
                var t = e.data,
                    ...
                    o = t.currentEl,
                    i = void 0 === o ? null : o;
                wt(t), r && function setMobileFocusLoop() {
            ...
            "kill-frame": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee4(e) {
                    ...
                    return i.a.wrap(function _callee4$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", ht({
                                    name: t.name
                                }));
                            case 2:
                            case "end":
            ...
            "get-cookie-value": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee6(e) {
                    ...
                    return i.a.wrap(function _callee6$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", _e.a.get(t.name));
                            case 2:
                            case "end":
                                return n.stop()
                        }
            ...
            "get-host-cookies": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee7() {
                    return i.a.wrap(function _callee7$(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.abrupt("return", _e.a.get());
                            case 1:
                            case "end":
                                return e.stop()
                        }
            ...
            storage: function() {
                var e = _asyncToGenerator(i.a.mark(function _callee9(e) {
                    ...
                    return i.a.wrap(function _callee9$(i) {
                        for (;;) switch (i.prev = i.next) {
                            case 0:
                                return t = e.data, n = t.type, r = t.method, o = t.args, a = "localStorage" === n ? wn : vn, i.abrupt("return", a[r].apply(a, _toConsumableArray(o)));
                            case 4:
                            case "end":
                                return i.stop()
                        }
            ...
            "handle-host-integration": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee10(e) {
                    ...
                    return i.a.wrap(function _callee10$(o) {
                        for (;;) switch (o.prev = o.next) {
                            case 0:
                                return t = e.data, n = t.config, "googleAnalyticsSettings" === (r = t.type) && Ir(n), "driftEngageVerification" === r && hr(n), "driftEngage" === r && mr(n), o.abrupt("return", r);
                            case 6:
                            case "end":
                                return o.stop()
                        }
            ...
            "clear-cookie": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee12(e) {
                    ...
                    return i.a.wrap(function _callee12$(i) {
                        for (;;) switch (i.prev = i.next) {
                            case 0:
                                return t = e.data, n = t.name, r = t.options, o = void 0 === r ? {} : r, i.abrupt("return", _e.a.remove(n, o));
                            case 3:
                            case "end":
                                return i.stop()
                        }
            ...
            "get-window-context": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee17() {
                    ...
                    return i.a.wrap(function _callee17$(i) {
                        for (;;) switch (i.prev = i.next) {
                            case 0:
                                return e = window.scrollX || window.pageXOffset, t = window.scrollY || window.pageYOffset, n = it(), r = n ? n.window : window, o = n ? n.document : window.document, a = Fr(function() {
                                    return {
                                        location: r.location,
                                        title: o.title,
                                        referrer: o.referrer,
                ...
                var e = _asyncToGenerator(i.a.mark(function _callee18(e) {
                    ...
                    return i.a.wrap(function _callee18$(n) {
                        for (;;) switch (n.prev = n.next) {
                            ...
                            case 3:
                                return n.abrupt("return", rt(t.name, t.meta));
                            case 4:
                            case "end":
                                return n.stop()
                        }
            ...
            "play-host-notification": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee21(e) {
                    ...
                    return i.a.wrap(function _callee21$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", On(t));
                            case 2:
                            case "end":
                                return n.stop()
                        }
            ...
            "controller:action-dispatch": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee30(e) {
                    ...
                    return i.a.wrap(function _callee30$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                if (t = e.data, window.drift_display_mode !== we.LANDING_PAGE) {
                                    n.next = 4;
                                    break
                                }
                                return ee({
            ...
            "get-frame-height": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee34(e) {
                    ...
                    return i.a.wrap(function _callee34$(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = e.data, n.abrupt("return", St(t));
                            case 2:
                            case "end":
                                return n.stop()
                        }
            ...
            "toggle-widget-controller": function() {
                var e = _asyncToGenerator(i.a.mark(function _callee40(e) {
                    ...
                    return i.a.wrap(function _callee40$(i) {
                        for (;;) switch (i.prev = i.next) {
                            case 0:
                                if (t = e.data, n = t.chatOpen, r = t.hasActiveConversation, o = t.isChatTakeover, zt(), r && Gt(), qt(n, r), !o) {
                                    i.next = 7;
                                    break
                                }
                                return i.abrupt("return");
            ...
            "sc::should-display-legacy-chat": function scShouldDisplayLegacyChat(e) {
                var t = e.data;
                yo.processCommand({
                    event: "should-display-legacy-chat",
                    name: "widgetv2",
                    shouldDisplay: t.shouldDisplay
                })
            }
        };
    ...
    var Wr = le(function() {
            var e;
            De() && (null === (e = window.drift) || void 0 === e ? void 0 : e.ready) && Dt() && ee({
                name: "chat",
                topic: "parent-scroll",
                message: {},
                waitForResponse: !1
        ...
        jr = function setupHostListeners() {
            Mr.forEach(function(e) {
                var t = e.event,
                    n = e.handler;
                ("scroll" !== t || De()) && ("popstate" !== t || !Fe() && ! function isLegacyEdgeBrowser() {
    ...
    var Ur = function IframeFactoryBase(e) {
        ...
        _classCallCheck(this, IframeFactoryBase), this._readyFrames = [], this._readyFrameListeners = {}, this._frameInstructions = [], this._frameCreationOptions = {}, this.initialize = function() {
            ...
            switch (e) {
                case N.CONTROLLER:
                    r = _defineProperty({
                        ...
                        hideController: window.drift_display_mode !== we.CHAT,
                        pageLoadStartTime: g(void 0, ["performance", "timing", "responseEnd"], window),
                        mode: g(we.CHAT, ["drift_display_mode"], window),
            ...
            var r = function onPrivateReadyHandlerFn() {
                this.setFrameReady(e), this._frameInstructions.length !== this._readyFrames.length || window.drift.allFramesReady || rt(Qe.ALL_FRAMES_READY)
            }.bind(t);
            document.addEventListener(Qe[n], r), t._readyFrameListeners["".concat(Qe[n])] = r
    ...
    var ro = function startTraceMark(e) {
        ...
        uo = function resolveCampaignRefreshToken() {
            var e = _e.a.get("drift_campaign_refresh"),
        ...
        fo = function resolveVisitorSession() {
            var e = vn.get("SESSION_STARTED"),
                t = (new Date).getTime() / 1e3,
                n = vn.get("SESSION_ID"),
                r = n || ie();
            n || vn.set("SESSION_ID", r), e || vn.set("SESSION_STARTED", t), window.drift_page_view_started = t, window.drift_session_started = e || t, window.drift_session_id = r
        },
        lo = function() {
            var e = _asyncToGenerator(i.a.mark(function _callee(e, t) {
                var n;
        ...
        wo = function isValidEvent(e, t) {
            return -1 === Object.keys(Ye).map(function(e) {
                return Ye[e]
        ...
        yo = new function Cohabitation() {
            var e = this;
            _classCallCheck(this, Cohabitation), this._apps = {}, this._queue = [], this.getAppElement = function(t) {
            ...
            }, this._getInLine = function(t) {
                e._isSiteConciergeRegistered() || "register" === t.event || e._queue.push(t)
            }, this.commandHandlers = {
                register: function register(t) {
                    if (e._apps[t.name]) se(["app already registered"]);
                    else if (window.drift_display_mode !== we.LANDING_PAGE) {
                        for ("site-concierge" === t.name && (window.drift.isCohabiting = !0, window.drift.hide(!0)), e._apps[t.name] = {
                                selector: t.selector
                            }; e._queue.length > 0;) {
                ...
                "should-display-legacy-chat": function shouldDisplayLegacyChat(t) {
                    e._isSiteConciergeRegistered() && window.driftV2.displayLegacyChatIcon(t)
                },
                ...
                e._getInLine(t), e.commandHandlers[t.event] && e.commandHandlers[t.event](t)
            }, this._apps = {}, this._queue = []
        },
        _o = function() {
            var e = _asyncToGenerator(i.a.mark(function _callee3(e) {
        ...
        bo = function config(e) {
            w(e.iframeMode) || (window.drift_iframe_mode = e.iframeMode), w(e.iframeSandbox) || (window.drift_iframe_sandbox = e.iframeSandbox), window.drift.controllerReady ? ee({
                name: "controller",
                topic: "trigger-api-event",
                message: {
                    method: "config",
        ...
        Ao = function identify(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            "string" === typeof e ? e && "undefined" !== e.toString() ? "string" === typeof e && e.length > 191 ? console.warn("DRIFT-API - drift.identify userId must be less than 191 characters but instead we got ".concat(e.length, " characters.")) : window.drift.controllerReady ? (t && t.hasProvidedIdentity || (ko(e), Co(t), n && n.userJwt && To(n.userJwt)), window.drift.ready ? Oo(e, t) : Io(e, t, n)) : window.drift.q.push(["identify", e, t, n]) : console.warn("DRIFT-API - drift.identify userId cannot be undefined") : console.warn("DRIFT-API - drift.identify userId must be string but instead we got ".concat(typeof e, "."))
        },
        ...
        Io = function _broadcastIdentityProvided(e, t, n) {
            ee({
                name: N.CONTROLLER,
        ...
        ko = function _broadcastIdentifyProvidedId(e) {
            ee({
                name: "controller",
        ...
        Ro = function throttledAPICall(e) {
            ...
            return Object(ft.throttle)(t, !0, e)
        }(function() {
        ...
        Bo = function resizeOnContextResize() {
            ...
            (Fo(t, "innerWidth", window.innerWidth) !== r || o !== n) && (Bt(), Lt(), de(window.drift.offset) || Et(window.drift.offset))
        },
        Wo = function() {
                ...
                return i.a.wrap(function _callee6$(t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 3:
                            return t.next = 5, Wo();
                        case 5:
                            e = t.sent, window.drift_frameFactory.unload(), ei(), gt(), Pn(null === e || void 0 === e ? void 0 : e.data), mn(), hn(), window.drift.embedId = void 0, window.drift.hasInitialized = !1;
                        case 14:
                        case "end":
                            return t.stop()
                    }
    ...
    window.__DRIFT_ENV__ = "PRODUCTION", window.__DRIFT_BUILD_ID__ = "20240924153838-5b77221", window.__DRIFT_BRANCH__ = "master";
    var zo = document.currentScript,
                    ...
                    for (;;) switch (r.prev = r.next) {
                        case 0:
                            e = window.drift && window.drift.q ? window.drift.q : [], (!(!window.drift || !window.drift.methods) || !(!window.driftt || !window.driftt.methods)) && (t = window.drift || window.driftt, n = Go(), e = [].concat(_toConsumableArray(n), _toConsumableArray(t)), window.drift = void 0, window.driftt = void 0), window.drift = function() {
                                (window.drift.q = window.drift.q || []).push(arguments), rt(Qe.CLEAR_EVENT_Q)
        ...
        Vo = function attachAPI() {
            window.drift.api = window.drift.api || {}, window.drift.api.sidebar = {
                ...
                close: $o("hideChat"),
                toggle: $o("toggleChat")
            }, Yo(Ve, window.drift.api), window.drift.api.widget = {}, Yo(Xe, window.drift.api.widget), window.drift.load = $o("init"), Yo(Ke, window.drift)
        },
        Xo = function handleQ() {
        ...
        ni = function attachEvents() {
            document.addEventListener(Qe.CLEAR_EVENT_Q, Xo), document.addEventListener(Ye.API_READY, Jo), document.addEventListener(Ye.READY, Ko), document.addEventListener(Qe.ALL_FRAMES_READY, Qo), document.addEventListener(Qe.DEBUG_INIT, ti)
        },
