function UET(o) {
    ...
    this.shouldEnforce = function(n) {
        return this.uetConfig.consent.enabled === !0 || this.uetConfig.tcf.enabled === !0 ? !1 : this.uetConfig.cusig.blob.bi === !0 ? !0 : (this.uetConfig.cusig.blob.ec === !0) ? this.uetConfig.cusig.blob.dt === !0 ? !0 : this.uetConfig.cusig.blob.at === !0 ? !1 : n.hasCookie === !1 ? !0 : !1 : !1
    };
    this.enforceConsent = function() {
        var n = this.getCmpData();
        this.shouldEnforce(n) ? (this.uetConfig.consent.enabled = !0, this.uetConfig.consent.adStorageAllowed = !1, this.uetConfig.consent.enforced = !0, delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid) : n.hasCookie && this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.consent.enforced = !1)
    };
